...
echo ""
echo "Option 2: Use the Forge UI after starting"
echo "  - Start the service: docker compose up sd-forge mediator web"
echo "  - Access UI at: http://localhost:7860"
echo "  - The UI can detect models placed in the models volume"
echo "  - You'll still need to manually download models from CivitAI or HuggingFace"
echo ""
...
echo ""
echo "3. Download models manually (if you haven't already):"
echo "   - Visit https://civitai.com or https://huggingface.co"
echo "   - Download models like SDXL-Lightning to your local machine"
echo "   - Copy them to the models volume:"
echo "     docker cp model.safetensors \$(docker compose ps -q sd-forge):/stable-diffusion-webui/models/Stable-diffusion/"
echo "   - Or restart the service to detect models in mounted volumes"
echo ""
