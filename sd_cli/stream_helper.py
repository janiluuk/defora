...
Usage:
  python -m sd_cli.stream_helper start --source /path/to/frames --target rtmp://example/live/streamkey
  python -m sd_cli.stream_helper status
  python -m sd_cli.stream_helper stop
