...
const CompositorControls = { props: ['app'], setup(props) { return __proxyAppView(props); }, components: { LiveEngineControls: LiveEngineControls }, template: "<LiveEngineControls :app=\"app\" :show-compositor=\"true\" :show-webgl=\"false\" force-performance />" };
