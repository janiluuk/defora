...
const Timeline = { props: ['app'], template: '<div></div>' };
...
const MorphCrossfaderPanel = { props: ['app'], template: '<div></div>' };
const ModulationActiveModsPanel = { props: ['app'], template: '<div></div>' };
