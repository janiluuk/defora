...
describe('deforum-controlnet-config', () => {
  ...
  it('syncs mediator slots from deforum units', () => {
    const settings = {
      cn_1_enabled: true,
      cn_1_weight: '0:(0.5)',
  ...
  it('syncs deforum units from mediator slots', () => {
  ...
  it('infers preset from module name', () => {
    assert.equal(inferModulePresetId({ cn_4_module: 'openpose' }, 4), 'openpose');
  });

  it('filters models by module hints', () => {
    const models = [
