...
import {
  ...
  parseWanResolution,
  buildAnimationPromptsJson,
} from "../src/shared/wan-engine-config.mjs";

describe("wan-engine-config", () => {
  it("parses wan resolution strings", () => {
  ...
  it("merges wan settings into deforum payload", () => {
  ...
  it("builds animation_prompts from prompts object", () => {
